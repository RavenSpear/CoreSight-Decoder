...
-- Command     : write_vhdl -force -mode funcsim -rename_top CoreSight_Decode_Decoder_Debugger_0_0 -prefix
--               CoreSight_Decode_Decoder_Debugger_0_0_ CoreSight_Decode_Decoder_Debugger_0_0_sim_netlist.vhdl
...
entity CoreSight_Decode_Decoder_Debugger_0_0_Decoder_Debugger is
  port (
    led : out STD_LOGIC_VECTOR ( 7 downto 0 );
    dbg_intr : in STD_LOGIC_VECTOR ( 2 downto 0 );
    trace_clk : in STD_LOGIC;
    trace_data : in STD_LOGIC_VECTOR ( 23 downto 0 )
  );
end CoreSight_Decode_Decoder_Debugger_0_0_Decoder_Debugger;

architecture STRUCTURE of CoreSight_Decode_Decoder_Debugger_0_0_Decoder_Debugger is
  ...
  signal count4 : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \count4[2]_i_1_n_0\ : STD_LOGIC;
  signal \count4[2]_i_3_n_0\ : STD_LOGIC;
  signal \count4[2]_i_4_n_0\ : STD_LOGIC;
  signal \count4[2]_i_5_n_0\ : STD_LOGIC;
  signal \count4[2]_i_6_n_0\ : STD_LOGIC;
  signal \count4[2]_i_7_n_0\ : STD_LOGIC;
  signal dbgreg : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \dbgreg[2]_i_1_n_0\ : STD_LOGIC;
  signal outbyte : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \outbyte[0]_i_2_n_0\ : STD_LOGIC;
  signal \outbyte[1]_i_2_n_0\ : STD_LOGIC;
  signal \outbyte[2]_i_2_n_0\ : STD_LOGIC;
  signal \outbyte[3]_i_1_n_0\ : STD_LOGIC;
  signal \outbyte[4]_i_1_n_0\ : STD_LOGIC;
  signal \outbyte[5]_i_1_n_0\ : STD_LOGIC;
  signal \outbyte[6]_i_1_n_0\ : STD_LOGIC;
  signal \outbyte[7]_i_1_n_0\ : STD_LOGIC;
  signal \outbyte[7]_i_2_n_0\ : STD_LOGIC;
  signal \outbyte[7]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \count4[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \count4[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \count4[2]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \outbyte[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \outbyte[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \outbyte[2]_i_1\ : label is "soft_lutpair2";
begin
...
\count4[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\count4[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\count4[2]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\count4[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
...
\count4[2]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
...
\count4[2]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\count4[2]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
...
\count4[2]_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
...
\count4_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\dbgreg[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0F0E"
    )
        port map (
...
\dbgreg_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => trace_clk,
      CE => \dbgreg[2]_i_1_n_0\,
      D => dbg_intr(0),
...
\dbgreg_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => trace_clk,
      CE => \dbgreg[2]_i_1_n_0\,
      D => dbg_intr(1),
...
\dbgreg_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => trace_clk,
      CE => \dbgreg[2]_i_1_n_0\,
      D => dbg_intr(2),
...
\outbyte[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"3A0A0A0A"
    )
        port map (
...
\outbyte[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\outbyte[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"3A0A0A0A"
    )
        port map (
...
\outbyte[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
\outbyte[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"3A0A0A0A"
    )
        port map (
...
\outbyte[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
\outbyte[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\outbyte[7]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF01"
    )
        port map (
...
\outbyte[7]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"55C050C005C000C0"
    )
        port map (
...
entity CoreSight_Decode_Decoder_Debugger_0_0 is
  ...
  attribute NotValidForBitStream of CoreSight_Decode_Decoder_Debugger_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of CoreSight_Decode_Decoder_Debugger_0_0 : entity is "CoreSight_Decode_Decoder_Debugger_0_0,Decoder_Debugger,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of CoreSight_Decode_Decoder_Debugger_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of CoreSight_Decode_Decoder_Debugger_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of CoreSight_Decode_Decoder_Debugger_0_0 : entity is "Decoder_Debugger,Vivado 2021.2";
end CoreSight_Decode_Decoder_Debugger_0_0;

architecture STRUCTURE of CoreSight_Decode_Decoder_Debugger_0_0 is
...
begin
inst: entity work.CoreSight_Decode_Decoder_Debugger_0_0_Decoder_Debugger
     port map (
      dbg_intr(2 downto 0) => dbg_intr(2 downto 0),
      led(7 downto 0) => led(7 downto 0),
      trace_clk => trace_clk,
      trace_data(23 downto 0) => trace_data(23 downto 0)
    );
end STRUCTURE;
