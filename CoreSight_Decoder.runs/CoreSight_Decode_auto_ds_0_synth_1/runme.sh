...
HD_PWD='/home/marvin/VivadoPrj/CoreSight_Decoder/CoreSight_Decoder.runs/CoreSight_Decode_auto_ds_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CoreSight_Decode_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CoreSight_Decode_auto_ds_0.tcl
