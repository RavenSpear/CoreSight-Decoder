...
HD_PWD='/home/marvin/VivadoPrj/CoreSight_Decoder/CoreSight_Decoder.runs/CoreSight_Decode_rst_ps8_0_99M_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CoreSight_Decode_rst_ps8_0_99M_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CoreSight_Decode_rst_ps8_0_99M_2.tcl
